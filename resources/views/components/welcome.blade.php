<div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col items-center p-6 lg:p-8 bg-[#FDFDFC] text-[#1b1b18] min-h-screen w-full">

                <!-- Title -->
                <div class="mb-8 text-center">
                    <h1 class="text-3xl lg:text-5xl font-bold">Welcome to your personal space</h1>
                    <p class="text-lg lg:text-xl text-[#706f6c] mt-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-7xl">
                    ...
                    <div class="bg-white rounded-lg shadow p-6 flex flex-col justify-between hover:shadow-xl transition">
                        <div>
                            <h3 class="text-xl font-semibold mb-2">New Task</h3>
                            <p class="text-gray-600 text-sm">
                                Add a new task to your list.
                            </p>
                        </div>
                        <a href="{{ route('tasks.create') }}" 
                           class="mt-4 inline-block px-4 py-2 bg-yellow-400 text-[#1b1b18] rounded-md font-medium text-center hover:bg-yellow-300 transition">
                            Add
                        </a>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow p-6 flex flex-col justify-between hover:shadow-xl transition">
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">
                                View all tasks that are still pending.
                            </p>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow p-6 flex flex-col justify-between hover:shadow-xl transition">
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">
                                Check all tasks you have completed.
                            </p>
                        </div>
